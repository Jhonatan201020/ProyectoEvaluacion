...
<body>
    ...
    <div class="sidebar sidebar-fixed border-end" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.sedes.index') }}">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-bank') }}"></use>
                </svg> Sedes</a>
            </li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.trabajadores.index') }}">
                <svg class="nav-icon">
                    <use xlink:href="{{ asset('vendors/@coreui/icons/svg/brand.svg#cib-slideshare') }}"></use>
                </svg> Trabajadores</a>
            </li>
            <li class="nav-title">Patrimonio</li>
            <li class="nav-item"><a class="nav-link" href="{{ route('admin.bienes.index') }}">
                <svg class="nav-icon">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                <svg class="nav-icon">
                <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-barcode') }}"></use>
                </svg> Inventario</a>
                <ul class="nav-group-items compact">
                    <li class="nav-item"><a class="nav-link" href="{{ asset('buttons/buttons.html') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Buttons</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ asset('buttons/button-group.html') }}"><span class="nav-icon"><span class="nav-icon-bullet"></span></span> Buttons Group</a></li>
